...
# 얼굴 탐지기 로딩
# rototxt  file as a plain text configuration which follows a JSON-like structure
'''
.prototxt
- 모델의 레이어 구성 및 속성 정의
...
# 리스트 외의 자료형을 저장할 때 pickle 모듈을 사용
# load시켜주면 자료형을 불러올 수 있음
...
while True:
	...
	# frame : image array
	# scale factor : 100% of the image
	# center crop : 300, 300 crop => use whole image
	# RGB mean 
	(h, w) = frame.shape[:2]
